...
import com.alibaba.shopping.shopping_bean.anno.annotation.Lock;
...
public class User extends IdEntity {
	...
	@JoinTable(name = "wemall_user_role", joinColumns = {@javax.persistence.JoinColumn(name = "user_id")}, inverseJoinColumns = {@javax.persistence.JoinColumn(name = "role_id")})
