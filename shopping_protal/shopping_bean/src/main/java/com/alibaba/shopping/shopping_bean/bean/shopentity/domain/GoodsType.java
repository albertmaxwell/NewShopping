...
public class GoodsType extends IdEntity {
    ...
    //商品规格集合
    @ManyToMany
    @JoinTable(name = "wemall_goodstype_spec", joinColumns = {@javax.persistence.JoinColumn(name = "type_id")}, inverseJoinColumns = {@javax.persistence.JoinColumn(name = "spec_id")})
