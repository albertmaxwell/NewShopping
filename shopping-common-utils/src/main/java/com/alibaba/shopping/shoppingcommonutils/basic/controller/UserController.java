...
import com.alibaba.shopping.shoppingcommonutils.basic.model.User;
import com.alibaba.shopping.shoppingcommonutils.basic.service.IRoleService;
import com.alibaba.shopping.shoppingcommonutils.basic.service.IUserService;
import com.alibaba.shopping.shoppingcommonutils.basic.service.UserRoleServiceImpl;
import com.alibaba.shopping.shoppingcommonutils.basic.tools.SecurityUtil;
...
public class UserController {
    ...
    public String roles(Model model, @PathVariable Integer id, HttpServletRequest request) {
        model.addAttribute("user", userService.findById(id).get()); //获取当前用户
    ...
    public @ResponseBody
	String addOrDelUserRole(Integer userId, Integer roleId) {
        try {
