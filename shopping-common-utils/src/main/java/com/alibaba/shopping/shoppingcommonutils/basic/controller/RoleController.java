package com.alibaba.shopping.shoppingcommonutils.basic.controller;

import com.alibaba.shopping.shoppingcommonutils.basic.annotations.AdminAuth;
import com.alibaba.shopping.shoppingcommonutils.basic.annotations.Token;
import com.alibaba.shopping.shoppingcommonutils.basic.exception.SystemException;
import com.alibaba.shopping.shoppingcommonutils.basic.model.Role;
import com.alibaba.shopping.shoppingcommonutils.basic.service.IRoleService;

import com.alibaba.shopping.shoppingcommonutils.basic.service.MenuServiceImpl;
import com.alibaba.shopping.shoppingcommonutils.basic.service.RoleMenuServiceImpl;
import com.alibaba.shopping.shoppingcommonutils.basic.tools.PinyinToolkit;
import com.alibaba.shopping.shoppingcommonutils.basic.tools.TokenTools;
import com.alibaba.shopping.shoppingcommonutils.basic.utils.PageableUtil;
import com.alibaba.shopping.shoppingcommonutils.basic.utils.ParamFilterUtil;
...
public class RoleController {
    ...
    public String menus(Model model, @PathVariable Integer id, HttpServletRequest request) {
        ...
        model.addAttribute("role", roleService.findById(id).get()); //获取当前角色
...
//		Boolean isRepeat = (Boolean) request.getAttribute("isRepeat");
    ...
    public @ResponseBody
	String addOrDelRoleMenu(Integer roleId, Integer menuId) {
        try {
